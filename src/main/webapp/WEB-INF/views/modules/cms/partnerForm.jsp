...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/partner/form?id=${partner.id}">合作伙伴<shiro:hasPermission name="cms:article:edit">${not empty partner.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:article:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="partner" action="${ctx}/cms/partner/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="icon" type="files" uploadPath="/cms/partner" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
